...
class DoublyLinkedList:
    ...
    def insert_after(self, node: DListNode, val: int) -> DListNode:
        ...
        n.prev = node
        node.next.prev = n
        node.next = n  # type: ignore
        self.size += 1
        return n

    def insert_head(self, val: int) -> DListNode:
        return self.insert_after(self.head, val)

    def insert_tail(self, val: int) -> DListNode:
        return self.insert_after(self.tail.prev, val)  # type: ignore
