...
class Stack:
    ...
    def __init__(self) -> None: self._d: List = []
    def push(self, v: object) -> None: self._d.append(v)
    def pop(self) -> Optional[object]: return self._d.pop() if self._d else None
    def peek(self) -> Optional[object]: return self._d[-1] if self._d else None
...
class MinStack:
    ...
    1
    """
    def __init__(self) -> None: self.s: List[int] = []; self.mn: List[int] = []
    def push(self, v: int) -> None:
        self.s.append(v)
        self.mn.append(v if not self.mn else min(v, self.mn[-1]))
    def pop(self) -> None: self.s.pop(); self.mn.pop()
...
class Queue:
    ...
    def __init__(self) -> None: self._d: deque = deque()
    def enqueue(self, v: object) -> None: self._d.append(v)
    def dequeue(self) -> Optional[object]: return self._d.popleft() if self._d else None
    def front(self) -> Optional[object]: return self._d[0] if self._d else None
    def is_empty(self) -> bool: return len(self._d) == 0
    def __len__(self) -> int: return len(self._d)
...
class QueueFromStacks:
    ...
    def __init__(self) -> None: self.s1: List = []; self.s2: List = []
    def push(self, v: object) -> None: self.s1.append(v)
...
def daily_temperatures(temps: List[int]) -> List[int]:
    ...
    [1, 1, 4, 2, 1, 1, 0, 0]
    """
    res = [0]*len(temps); stack: List[int] = []
...
def largest_rectangle_histogram(heights: List[int]) -> int:
    ...
    10
    """
    stack: List[tuple] = []; max_area = 0
    for i, h in enumerate(heights + [0]):
        start = i
        while stack and stack[-1][1] > h:
            j, ht = stack.pop(); max_area = max(max_area, ht*(i-j)); start = j
